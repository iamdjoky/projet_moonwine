    ...
    return ( 
        ...
        <div className={styles.certificate}>
            <div class="min-h-screen width-screen h-full bg-red bg-local">
               ...
               <Link href="/home"><a class="px-4 py-2 rounded-2_5 bg-white text-16 w-15 text-center text-red">ACCÉDER AU SITE</a></Link> 
                <button class="text-white text-16 ml-4">SORTIR</button>
                </div>

                <p class="text-white text-16 text-center mt-14 text-white">
